const SkillCard = ({ title, iconUrl, invertImage, isActive, onClick }) => (
  <div
    className={`${
      isActive
        ? "bg-defaultDarkerBlurBackground text-secondary"
        : "bg-defaultLightBlurBackground"
    } text-center backdrop-blur-lg relative cursor-pointer transition-all duration-[0.3s] ease-[ease] p-10 rounded-[0.65rem] border-[1.5px] border-solid border-primary hover:text-secondary hover:bg-defaultDarkBlurBackground`}
    onClick={() => onClick()}
  >
